...
public class RgbImage implements RgbImageModel {
  ...
  public RgbImageModel brighten(int increment) throws IllegalArgumentException {
    ...
    return new RgbImage(
            red.addBuffer(increment),
            green.addBuffer(increment),
            blue.addBuffer(increment),
            maxPixelValue);
  }
  ...
  public RgbImageModel darken(int decrement) throws IllegalArgumentException {
    ...
    return new RgbImage(
            red.addBuffer(decrement),
            green.addBuffer(decrement),
            blue.addBuffer(decrement),
            maxPixelValue);
  }
  ...
  public RgbImageModel blur() {
    ...
    return new RgbImage(
            red.applyConvolution(kernel),
            green.applyConvolution(kernel),
            blue.applyConvolution(kernel),
            maxPixelValue);
  }
