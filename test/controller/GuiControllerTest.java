...
/**
 * Test class for the GuiController class.
 */
public class GuiControllerTest {
  ...
  static class JFrameViewMock implements GuiView {
    ...
    public void resetInputSliders() {
      viewLog.append("reset input sliders");
    }
  ...
  private void getLogForApplyOperation(boolean isPreview) {
    ...
    expViewLog.append("Histogram of Image : \n");
    getexpViewLog();
    expViewLog.append("reset input sliders");
  }
  ...
  public void testHandleSaveButtonForNoImage() {
    ...
    //THEN
    assertEquals("No Image to Save", viewLog.toString());
  }
  ...
  public void testCancel() {
    ...
    expViewLog.append("Histogram of Image : \n");
    getexpViewLog();
    expViewLog.append("reset preview slider");
    //THEN
    assertEquals(expModelLog.toString(), modelLog.toString());
    assertEquals(expViewLog.toString(), viewLog.toString());
  }
